(module
 ...
 (func $~start
  ...
  block $folding-inner0
   ...
   i64.const 0
   i64.store
   block $__inlined_func$~instanceof|managed-cast/Cat$85 (result i32)
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.store offset=4
    i32.const 0
    ...
    i32.const 4
    i32.ne
    br_if $__inlined_func$~instanceof|managed-cast/Cat$85
    drop
    i32.const 1
   end
   i32.eqz
   ...
   i32.const 0
   i32.store offset=8
   block $__inlined_func$~instanceof|managed-cast/Cat$88 (result i32)
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.store offset=4
    global.get $~lib/memory/__stack_pointer
    ...
    i32.const 4
    i32.ne
    br_if $__inlined_func$~instanceof|managed-cast/Cat$88
    drop
    i32.const 1
   end
   i32.eqz
   ...
   block $__inlined_func$~instanceof|managed-cast/Cat$91 (result i32)
    ...
    i32.const 4
    i32.ne
    br_if $__inlined_func$~instanceof|managed-cast/Cat$91
    drop
    i32.const 1
   end
   i32.eqz
