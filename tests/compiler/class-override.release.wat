(module
 ...
 (global $class-override/x (mut i32) (i32.const 0))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34308))
 (memory $0 1)
 ...
 (data $8.1 (i32.const 1448) "\02\00\00\00\"\00\00\00c\00l\00a\00s\00s\00-\00o\00v\00e\00r\00r\00i\00d\00e\00.\00t\00s")
 (data $9 (i32.const 1504) "\08\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00 \00\00\00 \00\00\00 ")
 (export "fn" (func $class-override/fn))
 ...
 (func $~start
  ...
  (local $3 i32)
  (local $4 i32)
  block $__inlined_func$start:class-override
   memory.size
   i32.const 16
   i32.shl
   i32.const 34308
   ...
   block $folding-inner0
    ...
    global.set $~lib/memory/__stack_pointer
    local.get $0
    global.set $class-override/x
    i32.const 0
    call $class-override/fn
    i32.const 111
    i32.ne
    if
     i32.const 0
    ...
    br $__inlined_func$start:class-override
   end
   i32.const 34336
   i32.const 34384
   i32.const 1
 ...
 (func $class-override/B#f (param $0 i32) (param $1 i32) (result i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  global.set $~lib/memory/__stack_pointer
